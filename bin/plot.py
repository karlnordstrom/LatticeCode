...
plt.errorbar(normal_t/2+0.01, normal_val, yerr=normal_err, color='blue', linestyle='None', label="$1^{st}$ order")
plt.errorbar(improved_t/2-0.01, improved_val, yerr=improved_err, color='red', linestyle='None', label="$2^{nd}$ order")
plt.xlim([0,3])
plt.ylim([1.5,2.5])
